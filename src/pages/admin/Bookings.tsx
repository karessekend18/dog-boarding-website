...
export default function AdminBookings() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'completed': return 'bg-forest-light/20 text-forest';
        ...
        <div className="container">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Manage all your bookings and reservations.</p>
            </div>
            <Button>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-secondary/50">
                    <tr>
                      <th className="text-left p-4 font-semibold text-foreground">Dog</th>
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {booking.notes && (
                                <p className="text-xs text-muted-foreground truncate max-w-[150px]">{booking.notes}</p>
                              )}
                            </div>
                          </div>
                        </td>
                        <td className="p-4">
                          <p className="text-foreground">{booking.ownerName}</p>
                          <p className="text-xs text-muted-foreground">{booking.phone}</p>
                        </td>
                        <td className="p-4 text-foreground">{booking.service}</td>
                        <td className="p-4 text-foreground">{booking.checkIn}</td>
                        <td className="p-4 text-foreground">{booking.checkOut}</td>
                        <td className="p-4">
